...
// This function performs the riot connect action
export default async function connectRiot(riot_code: string) {
    ...
    const response = await fetch(api + `/user/connect/riot?code=${riot_code}`, {
        method: "PUT",
        headers,
    });
