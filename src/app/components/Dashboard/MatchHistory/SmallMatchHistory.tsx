  ...
  return (
    <>
      <div>
        ...
        >
          <div
            className={`rounded-lg grid grid-cols-11 items-center bg-gradient-to-r ${
          ...
          >
            <Image
              ...
              height={1000}
              alt=""
              className="ml-5 lg:w-20 w-12 h-auto object-cover flex justify-center"
            />
...
export default SmallMatchHistory;
