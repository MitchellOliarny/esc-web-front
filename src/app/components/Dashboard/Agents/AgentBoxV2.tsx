...
const AgentBoxV2 = ({ agentGames, agentAverages, agentId }: AgentBoxProps) => {
  ...
  return (
    <>
      <div
        id="main-container"
        className="w-full h-full stat-box-border overflow-hidden"
        style={{
          display: "grid",
          ...
          >
            <div className="h-full">
              <Image
                ...
                className="scale-[2.5] object-cover object-top translate-y-24"
                width={1000}
                height={1000}
                alt="Top Agent"
              />
