                ...
                <div className="w-full h-auto mt-8 back-graphite game-row-border rounded-lg">
                        ...
                        <div className="col-span-4 p-8 h-full">
                            ...
                            <div className="py-8">
                                ...
                                <div className="w-full inline-flex justify-between px-4">
                                    <h2 className="font-bold text-frost text-lg">{((progress.progress / (displayMedal == 5 ? medalInfo.medal_tiers[4].condition : medalInfo.medal_tiers[displayMedal + 1].condition)) * 100).toFixed(1)} %</h2>
                    ...
                    <div className="h-14 flex back-darkslate rounded-b-lg game-row-border-top w-full justify-between px-4">
                        ...
                        <div className="px-4 my-auto text-right">
                            ...
                            <p className="text-frost font-bold">{progress.tiers[displayMedal == 5 ? 4 : displayMedal].date_obtained ? formatDateYearShort(progress.tiers[displayMedal].date_obtained) : 'N/A'}</p>
                        </div>
                    </div>
                </div>
            }
