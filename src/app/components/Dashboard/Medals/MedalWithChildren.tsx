...
const MedalWithChildren = ({ medalInfo, progress, children_medals, all_children, child_progress, user_earners, change_display_medal, isPremiumUser, isMobile }: MedalsProps) => {
                ...
                <div className="w-full h-auto mt-8 back-graphite game-row-border rounded-lg">
                    <div className="h-90 rounded-t-lg relative">
                        ...
                        <img src={displayMedal != 0 ?
                            ...
                            className={`${displayMedal == 0 ? 'blur-sm grayscale' : ''} h-48 w-max m-auto p-4 pl-8 cursor-pointer`}
                            onClick={() => { setShowPopUp(showPopup == '' ? 'hidden' : '') }}
                        >
                        ...
                        <div className="col-span-4 p-8 h-full">
                            ...
                            {
                                isPremiumUser && medalInfo.isPremium == 1 ?
                                    <p className="text-ash text-base py-2 px-4 text-center">A new mastery tier medal is unlocked for every 20% complete</p>
                                    : ""
                            }
                            {
                                !isPremiumUser && medalInfo.isPremium == 1 ?
                                    <div className="py-8 px-4 text-center flex flex-col gap-4 cursor-pointer" onClick={() => { window.location.href = "/settings?view=Subscriptions" }}>
                                        <FaLock className="text-ash h-16 w-auto" />
                    ...
                    <div className={`${showPopup} h-auto game-row-border-top overflow-hidden py-4 pb-8 ${!isPremiumUser && medalInfo.isPremium == 1 ? 'blur-md' : ''}`}>
                        {
                            children_medals?.map((child: any, key: number) => {
                                ...
                                return (
                                    <div className="h-[8em] w-full medal-row-tier mt-2 mb-12" key={child?.name + key}>
                                        <div className="relative mr-4">
                                            ...
                                            <img src={
                                                ...
                                                className={`${tier == 0 ? 'blur-sm grayscale' : ''} h-auto w-max m-auto p-4 pl-8 z-10 relative scale-[1.75] translate-x-[-.5rem] translate-y-7`}>
                                            </img>
                                            <hr className="medal-tier-line-side"></hr>
                                            {
                                                tier >= 4 ?
                                        ...
                                        <div className="col-span-4 p-4 h-auto">
                                            <div className="flex flex-col">
                                                <div className="w-full font-bold">
                                                    <div className="col-span-2 flex gap-4">
                                                        <h2 className="text-base font-bold text-frost">{child?.medal_name}</h2>
                                                        <div className="back-slate text-frost self-center justify-self-start h-5 w-auto px-2 rounded-lg content-center justify-center text-xs font-bold">{
                                                ...
                                                <div className="my-auto text-left">
                                                    <p className="text-ash text-xs font-bold">Earned</p>
                                                    <p className="text-frost font-bold text-sm">{tier !== 0 && c_progress.tiers && c_progress.tiers[tier - 1].date_obtained ? formatDateYearShort(c_progress.tiers[tier - 1].date_obtained) : 'N/A'}</p>
                                                </div>
                                            </div>
                                            <div>
                                                <div className="w-full cut-corner-45-special">
                    ...
                    <div className="h-14 flex back-darkslate rounded-b-lg game-row-border-top w-full justify-between px-4 text-sm">
                        <div className="px-4 my-auto inline-flex gap-2">
                            ...
                            {/* </div>
                        <hr className="w-[0.05em] h-[2em] border-none back-slate my-auto mx-2 "></hr> */}
                            <p className="text-frost font-bold my-auto text-sm">{Number(medalInfo.medal_tiers[displayMedal ? displayMedal + '' : '1'] ? medalInfo.medal_tiers[displayMedal ? displayMedal + '' : '1'].population_earned : 0.0).toFixed(1)}% <span className="text-ash text-sm">players own this medal</span></p>
                        </div>
                        <div className="px-4 my-auto text-right">
